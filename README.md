...
Next, provide a suitable name for your custom runtime and proceed by uploading the **idefics-config-8bit.yaml.yaml** file mentioned above. Finally, ensure you save your changes by clicking on the save button.
